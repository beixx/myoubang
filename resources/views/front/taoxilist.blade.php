...
<div class="downNav bt00">
    <div class="ask">
        ...
        <input type="text" name="mobile" id="mobile" class="input" placeholder="请输入手机号，(<?php echo $tenants['count1'];?>人咨询)">
        <input type="submit" name="wapsubmit" class="btn" value="咨询套系·3分钟响应">
    </div>
...
<script>
    ...
    $(".shopclick").click(function(){
        $("input[name=wapsubmit]").val("咨询套系·3分钟响应");
    })
</script>
</body>
</html>