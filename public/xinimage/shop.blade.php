<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8">
 <title>{{$tenantinfo->name}}_{{$tenantinfo->city}}地区「第{{$tenantinfo->order_city}}名」有榜</title>
 <meta name="Keywords" content="{{$tenantinfo->name}},{{$tenantinfo->name}}怎么样,{{$tenantinfo->name}}行业第{{$tenantinfo->order_city}}名">
 <meta name="Description" content="{{$tenantinfo->name}}在{{$tenantinfo->city}}地区{{$tenantinfo->shoptype}}行业综合排名第{{$tenantinfo->order_city}}名，同时品牌榜单中{{$tenantinfo->name}}排名第{{$tenantinfo->brand_search_order}}名，好评榜单中排名第{{$tenantinfo->praise_order}}名，希望能够帮助您了解到{{$tenantinfo->name}}怎么样的问题。">
  ...
  <p>                
   ...
   <nav>            
    <a href="{{asset($pycity)}}/sheying">首页</a>
            ...
            <a href="/guize.html"  target="_blank">优选算法</a>
            <a rel="nofollow" href="http://youbangkeyi.mikecrm.com/BUmpmde"  target="_blank">修改店铺</a></nav>      
...
<div class="suolvd"><span><img src="{{asset($tenantinfo->cover)}}"></span></div><div class="txt">
<h1>{{$tenantinfo->name}} <?php if($tenantinfo->isVip==2){?><ins class="iconr"></ins><?php }  ?></h1>
<div class="t1">人均消费：<span class="red">¥{{$tenantinfo->person_price}}</span><span class="tc5">|</span><span>营业时间：</span>周一至周日 09:00-19:00</div>
...
<div class="baozhang"><span>底片全送</span><span>保证服务质量</span><span>不满意重拍</span><span>无隐形消费</span></div>
<hr><div class="datas">
...
<div class="foot">
        <div class="foots">
        <span><a href="/about.html">关于有榜</a>|<a target="_blank" href="http://youbangkeyi.mikecrm.com/E09npdx">商务合作</a>|<a href="/mianze.html">免责说明</a>|<a href="/shuoming.html">服务说明</a>|<a target="_blank" href="/xinimage/yingyezhizhao.jpeg">营业执照</a>|<a target="_blank" href="http://youbangkeyi.mikecrm.com/zJDl6sd">投诉建议</a>|<a target="_blank" href="http://youbangkeyi.mikecrm.com/QTsqDmZ">CEO信箱</a></span>
