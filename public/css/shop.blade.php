...
<?php }else { ?>
    ...
    <?php } ?>
<div class="jisuanqi click_are" onclick="showaa(this)"> <?php if($tenants['shoptype']=='婚纱摄影') { ?><div class="suan-wen"><p>你在他家拍婚纱照多少钱？</p>试试婚纱摄影计算器</div> <?php } else { ?><div class="suan-wen"><p>在他们家办婚礼多少钱？</p>试试婚礼计算器</div> <?php } ?><em></em></div>
<div class="daodianli">
           ...
           <?php } ?>
                    <a class="suolvk" href="/kpdetail/<?php echo $v['id']?>">
                        ...
                        <?php for($i = 0 ; $i<9 ; $i++) { if(empty($v['cover'][$i])) break; ?>
                            ...
                            <img src="//img2.youbangkeyi.com<?php echo $v['cover'][$i];?>?imageView2/1/w/250/h/250/q/75|imageslim" alt="<?php echo $v['picName']?>" />
                            <?php } else {?>
...
<link rel="stylesheet" href="/css/mns.css">
<div class="wrap">
    <div class="tabs">
        <a href="#" hidefocus="true" class="active">数据概况</a>
        <a href="#" hidefocus="true">擅长风格</a>
    </div>    
...
<div class="tel-box txtCtr">
    <a href="javascript:" class="ask rgt down">预约到店<em>(已有<?php echo $tenants['count2'];?>人预约)</em></a>
</div>
<div class="bgDiv"></div>
