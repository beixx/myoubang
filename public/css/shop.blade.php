...
<div class="logo"><a href="/<?php echo $pycity;?>"><img width="3.956rem" height="1.6rem" src="/images/logo.png"></a></div>
...
<div class="sjkap">
    <div class="txt_info">
        ...
        <p><span>人均消费:¥<?php echo $tenants['person_price'];?></span><span>|</span><span>线上消费用户<?php echo $tenantssort['allcy']?>人</span></p>
...
<div class="daodianli">
                <div class="daodiant">
                    ...
                    <div class="btm-line">
                        仅限到店使用
                        <span class="sm-text">230人感兴趣</span>
                    </div>
                </div>
