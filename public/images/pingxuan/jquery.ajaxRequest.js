...
var mSite = "http://m.hqew.com";
var wSite = "http://weixin.hqew.com";
...
$.fn.fillTbodyList = function(aList, pageOptions) {
    return this.each(function() {
        ...
        //呆滞料模块
        $(this).closest('.g-table1').siblings('.g-pagerwp').find('.g-pager').css('visibility', 'visible').pageBar1(pageOptions);
    });
}
...
$.fn.pageBar = function(options) {
    ...
    $.ajaxRequest = function(options) {
        ...
        var ajaxOptions = {
            ...
            requestParam: param,
            url: '/topic/common/WebAdapter.aspx?date=' + new Date().getTime(),
            type: "Post",
            dataType: "json",
            data: jsonData,
            error: function(msg) {
